...
| `related-machines/bike-race/v4.1/` | The six socketed chips of a Bike Race machine running V4.1 — see its [README](related-machines/bike-race/v4.1/README.md) |
...
| `related-machines/bike-race/v4.1/bk06.bin` | 131,072 bytes (128 KB) | `c42b2e81b987cbe63145eefda647da93` | 80188 graphics ROM, MCS1 `0x20000` (V4.1) |
