...
| IC8  | AMD PAL16L8A-2CN             | PDIP-20 | [PAL handbook](../datasheets/pal20l10_pal16l8_mmi_pal_handbook_1983.pdf) | Programmable Array Logic — Z80 memory and I/O decode. Inputs (sheet 011-030-01): `/M1`, `/MREQ`, `/IOREQ`, `/PWR`, `/PRD`, `A15`, `A14`, `A13`, `A12`, `A7`. Outputs: `/ROM1` (12, IC5 `/CE`), `/ROM2` (13, the vacant IC6), `/RI` (14, clears the interrupt latch), `/CEI` (15, IC16 enable), `/RAM` (16, becomes IC7's `/CRAM`), `/CEO` (17, IC17 enable), `/WR` (18), `/RD` (19). **Dumped, with an unresolved conflict** — the bench read recovers the I/O-read, I/O-write and interrupt-acknowledge decodes but no memory chip select: [`../roms/PAL16L8/`](../roms/PAL16L8/). |
