...
The actual consumer is almost certainly the documented PIC 16C57 at IC23 (the chip currently described only as a "DMD raster coprocessor"). The 16C57 has more than enough program memory (2 K × 12-bit) and I/O pins (20) to do both jobs in one chip. Earlier drafts of these docs hypothesised additional PICs at IC34 and "IC57" — those readings turned out to be a 74LS-series glue chip and a PAL 20L10 respectively, neither of them microcontrollers. See [`hardware_architecture.md`](hardware_architecture.md) for the corrected chip inventory and [`../research/80188_to_z80_mailbox.md`](../research/80188_to_z80_mailbox.md) for the full investigation. Confirming requires dumping IC23.
