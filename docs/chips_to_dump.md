...
| 4 | **IC24** | 011-029 | 16-pin DIP next to IC23; top-mark not yet read | Last remaining candidate PAL on the 16-bit board. Every other position in the IC20-IC22 cluster has been read off the physical chip and is plain 74-series glue (IC20/IC21 = 74LS393 dual counters, IC22 = 74LS27 triple NOR), so a PAL at IC24 is now unlikely but worth confirming. |
